...
const Navbar = () => {
    ...
    return (
        <div className="max-w-screen-xl mx-auto" >
            <div className="flex flex-row-reverse lg:flex-row items-center md:px-5 justify-between gap-0 lg:gap-[600px] py-4 md:py-6 pl-10 bg-black lg:bg-transparent lg:absolute lg:z-20">
